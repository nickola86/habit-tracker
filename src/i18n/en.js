export const en = {
    translations: {
        ...
        "Carico acqua":"Water refill",
        "Scarico acqua":"Water disposal",
        ...
        //Frigo
        "Questa pagina contiene informazioni sull'accensione e spegnimento del frigo.": "This page contains information on how to turn on and off the fridge.",
        "Il frigo è trivalente, questo vuol dire che può essere alimentato a gas se si è a veicolo fermo, con corrente elettrica 12v se si è a veicolo in movimento, con corrente elettrica 220v se si è nei campeggi connessi alla rete elettrica.": "The fridge is trivalent, this means that it can be powered by gas if you are with the vehicle stationary, with 12v electricity if you are on the move, or with 220v electricity if you are in campsites connected to the power line."
        ,"Gira il selettore sul tipo di alimentazione desiderata, ad esempio: gas.": "Turn the switch to the type of fuel you want, for example: gas."
        ,"Premi contemporaneamente il selettore della temperatura e il pulsante grigio di accensione.":"Press the temperature selector and the gray power button at the same time."
        ...
        ,"Rimuovere la bombola vuota":"Disconnect the empty cylinder"
        ,"Accedere al vano bombole":"Access the cylinder compartment"
        ,"Slegare le bombole":"Untie the cylinders"
        ,"Chiudere la bombola collegata all'impianto":"Close the connected cylinder"
        ,"Il rubinetto della bombola del gas ha la filettatura inversa, quindi il dado si":"The gas bottle tap has a reverse thread, so the nut is"
        ,"avvita in senso antiorario":"screwed on anti-clockwise"
        ,"e si":"and"
        ,"svita in senso orario":"unscrewed clockwise"
        ,"al contrario di come si fa con un dado standard!":"as opposed to a standard nut!"
        ,"Svitare in senso orario il tubo del gas collegato alla bombola":"Clockwise unscrew the gas pipe connected to the cylinder"
        ,"Installare la nuova bombola":"Connect the new cylinder"
        ,"Rimuovere il tappo della nuova bombola e la nuova guarnizione":"Remove the cap of the new cylinder and the new gasket"
        ,"Sostituire la vecchia guarnizione con la nuova":"Replace the old gasket with the new one"
        ,"Avvitare in senso antiorario il tubo del gas collegato alla bombola":"Screw the gas pipe connected to the cylinder anticlockwise"
